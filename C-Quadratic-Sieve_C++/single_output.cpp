...
void dfs128_print(u128 x,int t){  //print the formula for f(x).
	if (x<=n0){
		printf("(");
		cout<<s[x];
		printf(")");
...
int main()
{
	...
	//print_expr(u128_from_str("123"));
	//print_expr(u128_from_str("1234567890"));
	print_expr(u128_from_str("151770612880318395249730891"));
	//print_expr(u128_from_str("1361788799550131972374553991985921"));
	//check1();
	//check2();
	//check3();
	//check4();
